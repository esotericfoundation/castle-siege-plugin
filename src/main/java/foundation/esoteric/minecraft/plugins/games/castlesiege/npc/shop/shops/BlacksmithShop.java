package foundation.esoteric.minecraft.plugins.games.castlesiege.npc.shop.shops;

import lombok.Getter;
import net.kyori.adventure.text.minimessage.MiniMessage;
import foundation.esoteric.minecraft.plugins.games.castlesiege.api.gui.BaseGUI;
import foundation.esoteric.minecraft.plugins.games.castlesiege.npc.shop.ShopItemManager;
import foundation.esoteric.minecraft.plugins.games.castlesiege.util.Util;
import foundation.esoteric.minecraft.plugins.games.castlesiege.util.itemstack.ShopItemBuilder;
