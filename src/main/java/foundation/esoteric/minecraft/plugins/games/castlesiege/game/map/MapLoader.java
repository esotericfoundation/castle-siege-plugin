package foundation.esoteric.minecraft.plugins.games.castlesiege.game.map;
...
import foundation.esoteric.minecraft.plugins.games.castlesiege.npc.NPCBehaviour;
import foundation.esoteric.minecraft.plugins.games.castlesiege.npc.NPCSpawner;
