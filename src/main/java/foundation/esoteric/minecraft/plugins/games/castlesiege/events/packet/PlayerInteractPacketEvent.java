package foundation.esoteric.minecraft.plugins.games.castlesiege.events.packet;
...
import foundation.esoteric.minecraft.plugins.games.castlesiege.events.base.AbstractPacketEvent;
import foundation.esoteric.minecraft.plugins.games.castlesiege.game.data.player.TeamPlayer;
import foundation.esoteric.minecraft.plugins.games.castlesiege.npc.NPC;
import org.bukkit.entity.Player;

import java.lang.reflect.Field;
import java.util.List;

import static foundation.esoteric.minecraft.plugins.games.castlesiege.util.NMSUtil.toNMSPlayer;
