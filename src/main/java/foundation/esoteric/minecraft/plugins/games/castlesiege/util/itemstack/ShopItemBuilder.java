package foundation.esoteric.minecraft.plugins.games.castlesiege.util.itemstack;

import lombok.Getter;
import net.kyori.adventure.text.format.NamedTextColor;
import foundation.esoteric.minecraft.plugins.games.castlesiege.npc.shop.ShopCurrency;
